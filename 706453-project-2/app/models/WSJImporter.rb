# This class scrapes the data from the RSS feed: Wall Street Journal based on the link 
...
class Wsjimporter 
    ...
    # This method scrapes the data from the RSS feed for the Wall Street Journal
    # Journal and passes it into the articles table in the database, having
    # attributes which are accessible via the data scraped. Since we do not have
    # any authors mentioned for any of the articles being scraped, I have not
    # specified them here. But If we choose another source which does have authors,
    # we can easily add them by including them here.
	def scrape
